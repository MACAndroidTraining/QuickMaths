...
public class AmazonItemLookup {
     ...
     */
    private static final String AWS_ACCESS_KEY_ID = "AKIAJS3W7HDOJLZ7XYTQ";

    /*
     * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
     * Your Account page.
     */
    private static final String AWS_SECRET_KEY = "r+5MFsqqibtppRBe9ZMfg7OUm0C+JmFbW8uh12j3";
     ...
     */
    private static final String ITEM_ID = "767563135456";
...
//        String queryString = "Service=AWSECommerceService&Version=2009-03-31&AssociateTag=myers831-20&Operation=ItemLookup&ResponseGroup=Small&ItemId="
//                + ITEM_ID;
...
//        System.out.println();
    ...
    private static String fetchTitle(String requestUrl) {
        ...
        try {
            ...
            Node lItem = doc.getElementsByTagName("UPC").item(0);
            System.out.println("UPC: " + lItem.getTextContent());
